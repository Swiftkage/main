    ...
    public static Article[] getSampleArticles() {
        return new Article[] {
            new Article(new Name("Nike Wallet"), new Phone("87438807"), new Email("alexyeoh@example.com"),
                new Description("Found at Blk 30 Geylang Street 29, #06-40"), new Image("data/images/3.jpeg"), new Name("Alex Yeoh"),
                    new Name("Not Claimed"), Boolean.FALSE,
                getTagSet("Black")),
            new Article(new Name("Nike bag"), new Phone("99272758"), new Email("berniceyu@example.com"),
                new Description("Found at Blk 30 Lorong 3 Serangoon Gardens, #07-18"), new Image("data/images/4.jpg"), new Name("Bernice Yu"),
            ...
            new Article(new Name("Fitbit"), new Phone("93210283"), new Email("charlotte@example.com"),
                new Description("Found at Blk 11 Ang Mo Kio Street 74, #11-04"), new Image("data/images/5.jpg"), new Name("Charlotte Oliveiro"),
            ...
            new Article(new Name("Casio watch"), new Phone("91031282"), new Email("lidavid@example.com"),
                new Description("Found at Blk 436 Serangoon Gardens Street 26, #16-43"), new Image("data/images/6.png"),  new Name("David Li"),
            ...
            new Article(new Name("Bluetooth speaker"), new Phone("92492021"), new Email("irfan@example.com"),
                new Description("Found at Blk 47 Tampines Street 20, #17-35"), new Image("data/images/8.jpg"), new Name("Irfan Ibrahim"),
            ...
            new Article(new Name("IPhone 7"), new Phone("92624417"), new Email("royb@example.com"),
                new Description("Found at Blk 45 Aljunied Street 85, #11-31"), new Image("data/images/7.jpg"), new Name("Roy Balakrishnan"),
